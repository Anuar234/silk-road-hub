...
import { RequireAppUser } from './auth/requireAppUser'
import { RequireSeller } from './auth/requireSeller'
import { RequireAdmin } from './auth/requireAdmin'

const PublicLayout = lazy(async () => ({ default: (await import('./components/layout/PublicLayout')).PublicLayout }))
const AppLayout = lazy(async () => ({ default: (await import('./components/layout/AppLayout')).AppLayout }))
const AdminLayout = lazy(async () => ({ default: (await import('./components/layout/AdminLayout')).AdminLayout }))
...
const SellerDetailPage = lazy(async () => ({ default: (await import('./pages/SellerDetailPage')).SellerDetailPage }))
const AnalyticsFeedPage = lazy(async () => ({ default: (await import('./pages/AnalyticsFeedPage')).AnalyticsFeedPage }))
const AnalyticsArticlePage = lazy(async () => ({ default: (await import('./pages/AnalyticsArticlePage')).AnalyticsArticlePage }))
...
const InvestmentDetailPage = lazy(async () => ({ default: (await import('./pages/InvestmentDetailPage')).InvestmentDetailPage }))
...
const RequestAccessPage = lazy(async () => ({ default: (await import('./pages/RequestAccessPage')).RequestAccessPage }))
const NotFoundPage = lazy(async () => ({ default: (await import('./pages/NotFoundPage')).NotFoundPage }))

const VerificationPage = lazy(async () => ({ default: (await import('./pages/VerificationPage')).VerificationPage }))
