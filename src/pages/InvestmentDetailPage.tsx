...
import { getInvestmentById, INVESTMENT_STAGES, INVESTMENT_SOURCES } from '../data/investmentData'
import { CATALOG_SECTORS, getRegionByCode } from '../data/catalogStructure'
