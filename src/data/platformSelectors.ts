...
import { getAllDeals, getDealById, getDealsByBuyer, getDealsBySeller, type DealCase } from './dealData'
import { getExistingThread, getParticipantId, getSellerIdFromAuth, getThreadMessages, threads, type Thread } from './messagingData'
