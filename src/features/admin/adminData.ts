...
import { deals, getAllDeals, getDealProduct, getDealSeller, type DealCase, type DealStatus } from '@features/deals/dealData'
import { getThreadMessages, threads } from '@features/messaging/messagingData'
import { products, sellers, type Product, type Seller } from '@mocks/mockData'
